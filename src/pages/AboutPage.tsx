...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className="pt-24 pb-16">
      <div className="bg-primary text-white py-12 mb-12"> {/* Header section is already dark bg, light text */}
      ...
      <div className="container-custom">
        {/* Company Story - Inherits bg-primary (dark) from body */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            <h2 className="text-3xl font-heading font-medium mb-6">
              Our <span className="text-accent">Story</span>
            </h2>
            <p className="text-neutral mb-6"> {/* <--- CHANGED text-gray-700 to text-neutral */}
            ...
            <p className="text-neutral"> {/* <--- CHANGED text-gray-700 to text-neutral */}
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg"> {/* This card is light, text should be primary */}
            <img
        ...
        <div className="bg-neutral py-16 rounded-lg mb-20">
          <div className="container-custom">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <h2 className="text-3xl font-heading font-medium mb-4 text-primary"> {/* <--- ADDED text-primary */}
                Our Mission & Values
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-md"> {/* These cards are light */}
                <h3 className="text-2xl font-medium mb-4 text-primary">Our Mission</h3> {/* <--- ADDED text-primary */}
                <p className="text-gray-700 text-primary mb-6"> {/* <--- ADDED text-primary */}
                ...
                <p className="text-gray-700 text-primary"> {/* <--- ADDED text-primary */}
              ...
              <div className="bg-white p-8 rounded-lg shadow-md"> {/* These cards are light */}
                <h3 className="text-2xl font-medium mb-4 text-primary">Our Values</h3> {/* <--- ADDED text-primary */}
        ...
        {/* Team Section - Inherits bg-primary (dark) from body */}
        <div className="mb-20">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-heading font-medium mb-4">Our Team</h2> {/* Already text-neutral by global default */}
            <p className="text-neutral"> {/* <--- CHANGED text-gray-600 to text-neutral */}
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="text-center">
              <h3 className="text-xl font-medium">James Wilson</h3> {/* Already text-neutral by global default */}
              <p className="text-cta">Founder & CEO</p>
            </div>
            <div className="text-center">
              <h3 className="text-xl font-medium">Sarah Johnson</h3> {/* Already text-neutral by global default */}
              <p className="text-cta">Operations Director</p>
            </div>
            <div className="text-center">
              <h3 className="text-xl font-medium">David Mwangi</h3> {/* Already text-neutral by global default */}
              <p className="text-cta">East Africa Director</p>
            </div>
          </div>
        </div>

        {/* Stats Section - Inherits bg-primary (dark) from body */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          <div className="bg-white p-8 rounded-lg shadow-md text-center">
            <div className="bg-accent/10 text-accent p-4 rounded-full inline-block mb-4">
              <Award size={28} />
            </div>
            <div className="text-4xl font-bold text-primary mb-2">5+</div> {/* Already text-primary */}
            <p className="text-gray-600 text-primary">Years of Excellence</p> {/* <--- ADDED text-primary */}
          </div>
          <div className="bg-white p-8 rounded-lg shadow-md text-center">
            <div className="bg-accent/10 text-accent p-4 rounded-full inline-block mb-4">
              <Users size={28} />
            </div>
            <div className="text-4xl font-bold text-primary mb-2">250+</div> {/* Already text-primary */}
          ...
          <div className="bg-white p-8 rounded-lg shadow-md text-center">
            ...
            <div className="text-4xl font-bold text-primary mb-2">2</div> {/* Already text-primary */}
            <p className="text-gray-600 text-primary">Office Locations</p> {/* <--- ADDED text-primary */}
          </div>
          <div className="bg-white p-8 rounded-lg shadow-md text-center">
            <div className="bg-accent/10 text-accent p-4 rounded-full inline-block mb-4">
              <Shield size={28} />
            </div>
            <div className="text-4xl font-bold text-primary mb-2">100%</div> {/* Already text-primary */}
