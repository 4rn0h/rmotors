          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-cta mb-4">Founder & CEO</p>
                <p className="text-gray-600 mb-4">
                  With over 20 years in the luxury automotive industry, James brings unparalleled
                  expertise and passion to RoyaMotorsUK.
                </p>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-cta mb-4">Operations Director</p>
                <p className="text-gray-600 mb-4">
                  Sarah oversees all logistics and operations, ensuring seamless delivery from the UK
                  to East Africa for every vehicle.
                </p>
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-400 hover:text-blue-500">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-medium mb-1">David Mwangi</h3>
                <p className="text-cta mb-4">East Africa Director</p>
                <p className="text-gray-600 mb-4">
                  Based in Nairobi, David leads our East African operations, providing local expertise
                  and personalized service to our clients.
                </p>
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-400 hover:text-blue-500">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
